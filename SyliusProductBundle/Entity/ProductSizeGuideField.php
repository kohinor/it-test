...
class ProductSizeGuideField
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\SyliusProductBundle\Entity\ProductSizeGuide", inversedBy="fields", cascade={"persist"})
     * @ORM\JoinColumn(name="size_guide_id", referencedColumnName="id")
     */
    protected $sizeGuide;
    
    /**
    * @ORM\OneToMany(targetEntity="App\SyliusProductBundle\Entity\ProductSizeGuideValue", mappedBy="field"), cascade={"persist", "remove"}
    */
    protected $values;
