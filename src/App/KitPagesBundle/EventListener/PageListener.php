...
namespace App\KitPagesBundle\EventListener;
...
class PageListener {
    ...
    public function onKernelRequest(GetResponseEvent $event)
    {
        ...
        if ($viewMode == Context::VIEW_MODE_PROD) {
            ...
            if ($locale = $request->attributes->get('_locale')) {
                ...
                $request->setLocale($request->getSession()->get('_locale', $pagePublish->getLanguage()));
            }
            $this->fakeRouter(
                $request,
        ...
        if (($viewMode == Context::VIEW_MODE_EDIT) || ($viewMode == Context::VIEW_MODE_PREVIEW) ) {
            ...
            if ($locale = $request->attributes->get('_locale')) {
                ...
                $request->setLocale($request->getSession()->get('_locale', $page->getLanguage()));
            }
            $this->fakeRouter(
                $request,
                $page->getLanguage(),
    ...
    protected function fakeRouter($request, $locale, $pageId, $urlTitle)
    {
